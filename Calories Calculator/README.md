...
Датасет (1.3 ГБ): https://disk.yandex.ru/d/kz9g5msVqtahiw, который содержит фотографии блюд, описание ингредиентов, а также общую массу порции и калорийность.
...
```bash
https://disk.yandex.ru/d/e-xIFh-24YSRPQ
```